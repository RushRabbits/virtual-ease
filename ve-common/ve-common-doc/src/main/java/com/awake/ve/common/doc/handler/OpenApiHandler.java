package com.awake.ve.common.doc.handler;
...
public class OpenApiHandler extends OpenAPIService {
     ...
     * @param springDocConfigProperties the META-INF-spring.META-INF-spring.META-INF-spring.META-INF-spring.META-INF-spring doc config properties
