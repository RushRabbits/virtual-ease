...
import com.awake.ve.common.mybatis.annotation.DataColumn;
import com.awake.ve.common.mybatis.annotation.DataPermission;
import com.awake.ve.common.mybatis.enums.DataScopeType;
        ...
        for (RoleDTO role : user.getRoles()) {
            ...
            for (DataColumn dataColumn : dataPermission.value()) {
                ...
                if (StringUtils.isNotBlank(dataColumn.permission()) &&
                    ...
                    // 修复多角色与权限标识符共用问题 https://gitee.com/dromara/ve-Vue-Plus/issues/IB4CS4
